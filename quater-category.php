...
<body id="second" class="news second">
	...
	<div id="container">
		...
		<h3 style="margin: 0 0 1em;">県連活動</h3>
...
$args = array(
    ...
    'paged' => $paged,
    'category_name' => 'quater', // quarterカテゴリーの投稿のみを表示
);
...
<?php endif; ?>
				<dt>2023/3/3</dt>
				<dd><a href="<?php echo get_template_directory_uri(); ?>/04_news/news_20230303.html">埼玉県生協連ピースフォーラムを開催しました</a></dd>
				<dt>2023/2/24</dt>
				<dd><a href="../siryou/old/main/shou_dantai/23/0224.html">「ヤングケアラー、ケアラー支援について」を開催しました</a></dd>
				<dt>2023/2/24</dt>
				<dd><a href="<?php echo get_template_directory_uri(); ?>/04_news/news_20230224.html">「ウクライナ緊急募金」および「自然災害緊急募金」に寄付しました</a></dd>
				<dt>2023/2/10</dt>
				<dd><a href="<?php echo get_template_directory_uri(); ?>/04_news/news_20230227.html">2022年度埼玉県と埼玉県生協連との第2回定期協議を開催しました</a></dd>
				<dt>2023/2/10</dt>
				<dd><a href="<?php echo get_template_directory_uri(); ?>/04_news/news_20230210.html">組合員学習会を開催しました</a></dd>
				<dt>2023/2/9</dt>
				<dd><a href="<?php echo get_template_directory_uri(); ?>/04_news/news_20230209.html">3/2埼玉県生協連ピースフォーラムを開催します</a></dd>
				<dt>2023/2/9</dt>
				<dd><a href="../siryou/old/main/shou_dantai/23/0209.html"> 3/4第61回全国消費者大会が開催されます</a></dd>
				<dt>2023/2/1</dt>
				<dd><a href="<?php echo get_template_directory_uri(); ?>/04_news/news_20230131_sekyou50th.html">埼玉県生協連創立50周年記念祝賀会が開催されました</a></dd>
				<dt>2023/1/31</dt>
				<dd><a href="<?php echo get_template_directory_uri(); ?>/04_news/news_20230131.html">原子力政策に対する意見を提出しました</a></dd>
				<!--<dt>2023/1/25</dt>
			...
			<ul class="news_list">
				<li class="left"><a href="<?php echo get_template_directory_uri(); ?>/04_news/activity.html">
					<img class="ov" src="<?php echo get_template_directory_uri(); ?>/04_news/img/04_news_01.gif" width="335" height="72" alt="県連活動" />
				</a></li>
		...
		<!-- backnumber start -->
		<div id="backnumber">
			<?php include('include/backnumber.php'); ?>
		</div>
		<!-- backnumber end -->
		</div>
		<!-- main end -->
